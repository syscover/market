        <li{!! Miscellaneous::setCurrentOpenPage(['my-resource']) !!}>
            ...
            <ul class="sub-menu">
                @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'mifinan', 'access'))
                    <li{{ Miscellaneous::setCurrentPage('mifinan') }}><a href=""><i class="icomoon-icon-truck"></i>Fichas inversor</a></li>
                @endif
                <li{!! Miscellaneous::setCurrentOpenPage(['my-submenu-resource']) !!}>
                    ...
                    <ul class="sub-menu" >
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'my-submenu-resourcet', 'access'))
