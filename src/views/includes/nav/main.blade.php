<li{!! is_current_resource(['market-order','market-product','market-category','market-tax-customer','market-tax-customer-group','market-tax-product','market-tax-rate-zone','market-tax-setting','market-payment-method','market-order-status','market-tpv','market-tpv-paypal','market-tpv-paypal-setting','market-cart-price-rule']) !!}>
    ...
    <ul class="sub-menu">
        ...
        <li{!! is_current_resource(['market-tax','market-tax-customer','market-tax-customer-group','market-tax-product','market-tax-rate-zone','market-tax-setting'], true) !!}>
