...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('market::pulsar.order_status_successful'), 'name' => 'orderStatusSuccessful', 'value' => old('orderStatusSuccessful', isset($object->order_status_successful_id_115)? $object->order_status_successful_id_115 : null), 'objects' => $orderStatus, 'idSelect' => 'id_114', 'nameSelect' => 'name_114', 'fieldSize' => 5])
    <div class="row">
        <div class="col-md-6">
