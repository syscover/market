...
@section('rows')
    ...
    @include('pulsar::includes.html.form_select_group', ['label' => trans('market::pulsar.order_status'), 'name' => 'orderStatus', 'value' => $object->order_status_115, 'objects' => $orderStatus, 'idSelect' => 'id_114', 'nameSelect' => 'name_114', 'fieldSize' => 5])
    <div class="row">
        <div class="col-md-6">
