...
@section('rows')
    ...
    <div class="row">
        <div class="col-md-6">
            @include('pulsar::includes.html.form_text_group', [
                ...
                'label' => 'ID',
                'name' => 'id',
                'value' => old('id', isset($object->id_110)? $object->id_110 : null),
                'readOnly' => true
            ])
        </div>
        <div class="col-md-6">
    ...
    @include('pulsar::includes.html.form_select_group', [
        ...
        'data' => [
            ...
            'disabled' => isset($object->id_110)? true : null
        ]
    ])
    @include('pulsar::includes.html.form_text_group', [
        'label' => trans('pulsar::pulsar.name'),
        'name' => 'name',
        'value' => old('name', isset($object->name_110)? $object->name_110 : null),
        'maxLength' => '100',
        'rangeLength' => '2,100',
        'required' => true
    ])
    @include('pulsar::includes.html.form_text_group', [
        ...
        'name' => 'slug',
        'value' => old('slug', isset($object->slug_110)? $object->slug_110 : null),
        'maxLength' => '255',
        'rangeLength' => '2,255',
        'required' => true
    ])
