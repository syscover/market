    ...
    public function storeCustomRecord($parameters)
    {
        ...
        if(!$this->request->has('id'))
        {
            CartPriceRule::create([
                ...
                'total_used_120'                => 0,
                'enable_from_120'               => $this->request->input('enableFrom')? \DateTime::createFromFormat(config('pulsar.datePattern') . ' H:i', $this->request->input('enableFrom'))->getTimestamp() : null,
                'enable_from_text_120'          => $this->request->input('enableFrom')? $this->request->input('enableFrom') : null,
                'enable_to_120'                 => $this->request->input('enableTo')? \DateTime::createFromFormat(config('pulsar.datePattern') . ' H:i', $this->request->input('enableTo'))->getTimestamp() : null,
                'enable_to_text_120'            => $this->request->input('enableTo')? $this->request->input('enableTo') : null,
