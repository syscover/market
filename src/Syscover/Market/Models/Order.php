...
class Order extends Model
{
    ...
    {
        return number_format($this->subtotal_116, $decimals, $decimalPoint, $thousandSeparator);
    }
    ...
    {
        return number_format($this->discount_amount_116, $decimals, $decimalPoint, $thousandSeparator);
    }
    ...
    {
        return number_format($this->subtotal_with_discounts_116, $decimals, $decimalPoint, $thousandSeparator);
    }
    ...
    {
        return number_format($this->tax_amount_116, $decimals, $decimalPoint, $thousandSeparator);
    }
    ...
    {
        return number_format($this->cart_items_total_without_discounts_116, $decimals, $decimalPoint, $thousandSeparator);
    }
    ...
    {
        return number_format($this->shipping_amount_116, $decimals, $decimalPoint, $thousandSeparator);
    }
    ...
    {
        return number_format($this->total_116, $decimals, $decimalPoint, $thousandSeparator);
    }
}