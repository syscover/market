...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/market/paypal/web/profile',                                         ['as' => 'marketPayPalWebProfile',              'uses' => 'Syscover\Market\Controllers\PayPalController@index',                     'resource' => 'market-tpv-paypal-web-profile',          'action' => 'access']);
    Route::get(config('pulsar.appName') . '/market/tax/rule/create/{offset}',                                   ['as' => 'createMarketPayPalWebProfile',        'uses' => 'Syscover\Market\Controllers\TaxRuleController@createRecord',             'resource' => 'market-tpv-paypal-web-profile',          'action' => 'create']);
    Route::post(config('pulsar.appName') . '/market/tax/rule/store/{offset}',                                   ['as' => 'storeMarketPayPalWebProfile',         'uses' => 'Syscover\Market\Controllers\TaxRuleController@storeRecord',              'resource' => 'market-tpv-paypal-web-profile',          'action' => 'create']);
    Route::get(config('pulsar.appName') . '/market/tax/rule/{id}/edit/{offset}',                                ['as' => 'editMarketPayPalWebProfile',          'uses' => 'Syscover\Market\Controllers\TaxRuleController@editRecord',               'resource' => 'market-tpv-paypal-web-profile',          'action' => 'access']);
    Route::put(config('pulsar.appName') . '/market/tax/rule/update/{id}/{offset}',                              ['as' => 'updateMarketPayPalWebProfile',        'uses' => 'Syscover\Market\Controllers\TaxRuleController@updateRecord',             'resource' => 'market-tpv-paypal-web-profile',          'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/market/tax/rule/delete/{id}/{offset}',                              ['as' => 'deleteMarketPayPalWebProfile',        'uses' => 'Syscover\Market\Controllers\TaxRuleController@deleteRecord',             'resource' => 'market-tpv-paypal-web-profile',          'action' => 'delete']);
});
