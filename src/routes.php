...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/market/paypal/web/profile/create',                                  ['as' => 'createMarketPayPalWebProfile',        'uses' => 'Syscover\Market\Controllers\PayPalWebProfileController@createRecord',    'resource' => 'market-tpv-paypal-web-profile',          'action' => 'create']);
    Route::post(config('pulsar.appName') . '/market/paypal/web/profile/store',                                  ['as' => 'storeMarketPayPalWebProfile',         'uses' => 'Syscover\Market\Controllers\PayPalWebProfileController@storeRecord',     'resource' => 'market-tpv-paypal-web-profile',          'action' => 'create']);
    Route::get(config('pulsar.appName') . '/market/paypal/web/profile/{id}/edit',                               ['as' => 'editMarketPayPalWebProfile',          'uses' => 'Syscover\Market\Controllers\PayPalWebProfileController@editRecord',      'resource' => 'market-tpv-paypal-web-profile',          'action' => 'access']);
    Route::put(config('pulsar.appName') . '/market/paypal/web/profile/update/{id}',                             ['as' => 'updateMarketPayPalWebProfile',        'uses' => 'Syscover\Market\Controllers\PayPalWebProfileController@updateRecord',    'resource' => 'market-tpv-paypal-web-profile',          'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/market/paypal/web/profile/delete/{id}',                             ['as' => 'deleteMarketPayPalWebProfile',        'uses' => 'Syscover\Market\Controllers\PayPalWebProfileController@deleteRecord',    'resource' => 'market-tpv-paypal-web-profile',          'action' => 'delete']);
});
