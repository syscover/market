...
class MarketCreateTablePaymentMethod extends Migration
{
	...
	public function up()
	{
		...
		{
			Schema::create('012_115_payment_method', function ($table) {
				$table->engine = 'InnoDB';
				...
				// new order status
				$table->integer('order_status_115')->nullable()->unsigned();
				...
				$table->foreign('order_status_115', 'fk02_012_115_payment_method')->references('id_114')->on('012_114_order_status')
					->onDelete('restrict')->onUpdate('cascade');
			});
		}
	}
